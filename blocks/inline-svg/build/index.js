...
function edit({
  ...
  const [max, setMax] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(unit !== 'px' ? 100 : 1000);
  const [step, setStep] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)(unit !== 'px' ? 0.25 : 1);
  ...
  const onError = message => {
    console.log((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(`Something went wrong, please try again. Message: ${message}`, 'lito-blocks'));
  };
  const sizeStyle = () => {
    const styles = [];
    if (width > 0) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    labels: {
      title: 'SVG Site Logo',
      instructions: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Upload an SVG or pick one from your media library.', 'lito-blocks')
    }
  }), url && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_svg__WEBPACK_IMPORTED_MODULE_5__.ReactSVG, {
    src: url,
    beforeInjection: svg => {
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"lito/inline-svg","version":"0.1.0","title":"Svg Site Logo","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"keywords":["インライン","image","画像"],"textdomain":"lito-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js","attributes":{"textAlign":{"type":"string"}}}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunksvg_site_logo"] = globalThis["webpackChunksvg_site_logo"] || [];
